var vue = new Vue({
    ...
    methods: {
        ...
        searchLabelOnline: function () {
            ...
            axios.get('../../label/labelRecord/list', {params}).then(function (response) {
        ...
        formatDays: function (row, column, cellValue) {
    ...
    created: function () {
        axios.get('../../label/labelRecord/list', {
